...
export default function RegisterPage() {
  ...
  return (
    <AuthShell sideHeadline="What you get &middot; day one">
      <RotatingCaption style="mixed" />

      <h1 className="auth-title">Start a <em>board</em>.</h1>
      <p className="auth-subtitle">
        Free forever. No credit card. Your data stays yours, exportable as CSV on day one.
      </p>
      ...
      <form className="auth-form" onSubmit={handleSubmit}>
        ...
        <label className="auth-check">
          ...
          <span>I agree to the <a className="auth-link" href="#">terms</a> and <a className="auth-link" href="#">privacy notice</a></span>
        </label>
      ...
      <div className="auth-social">
        <a className="auth-social-btn" href="/api/auth/signin/google">
        ...
        <a className="auth-social-btn" href="/api/auth/signin/github">
      ...
      <p className="auth-foot">
        Already have a board? <Link href="/login">Sign in &rarr;</Link>
      </p>
    </AuthShell>
  );
}
